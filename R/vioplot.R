...
#'
#' New function  \code{\link[vioplot]{vioplotx}} has been developed with different default values. Otherwise, they function identically. This version kept for complete backwards-compatibility.
#'
