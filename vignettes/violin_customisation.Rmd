...
This should be sufficient to customise the violin plot but further examples are given in [the areaEqual vioplotx vignette](violin_area.html) including how violin plots are useful for comparing variation when data does not follow the same distribution. This document also compares the violin plot with other established methods to plot data variation.
