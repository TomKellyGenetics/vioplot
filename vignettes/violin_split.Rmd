...
```{r}
vioplotx(Sepal.Length~Species, data=iris_large, col = "palevioletred1", plotCentre = "point", side = "right", pchMed = 21, colMed = "palevioletred4", colMed2 = "palevioletred2")
vioplotx(Sepal.Length~Species, data=iris_small, col = "lightblue1", plotCentre = "point", side = "left", pchMed = 21, colMed = "lightblue4", colMed2 = "lightblue2", add = T)
title(xlab = "Species", ylab = "Sepal Length")
legend("topleft", fill = c("lightblue", "palevioletred"), legend = c("small", "large"), title = "Sepal Width")
```
...
```{r}
vioplotx(Sepal.Length~Species, data=iris_large, col = "palevioletred1", plotCentre = "line", side = "right", pchMed = 21, colMed = "palevioletred4", colMed2 = "palevioletred2")
vioplotx(Sepal.Length~Species, data=iris_small, col = "lightblue1", plotCentre = "line", side = "left", pchMed = 21, colMed = "lightblue4", colMed2 = "lightblue2", add = T)
points(1:length(levels(iris$Species)), as.numeric(sapply(levels(iris$Species), function(species) median(iris_large[grep(species, iris_large$Species),]$Sepal.Length))), pch = 21, col = "palevioletred4", bg = "palevioletred2")
...
#### Sources
The extensions to `violotx` here are based on those provided here:
